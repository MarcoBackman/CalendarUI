...
/*
 * Description : Color code collections
 * Each comment represents:
 *    Hex value of the color - Name of the color(HUE color).
 *    Upper branch within the smae hue indicates brigher color and vice versa.
 */
